...
def newYear():
    ...
    for i in range(-1, 100, 2):
        port.write(str.encode(f"1,{i},0,0,128#"))
...
def morningNewYear():
    ...
    for i in range(50):
        port.write(str.encode(f"5,{i},75,75,75#"))
        port.write(str.encode("show5#"))
        time.sleep(.02)
    ...
    for i in range(0, (day*2), 2):
        port.write(str.encode(f"1,{i},0,0,50#"))
        port.write(str.encode("show1#"))
        time.sleep(.1)
...
def fire_works():
    ...
    time.sleep(1)
    for i in range(32):
        port.write(str.encode(f"5, {i+50}, 250, 0,0#"))
    port.write(str.encode("show5#"))
    time.sleep(.4)
    
    for i in range(24):
        port.write(str.encode(f"5, {i+82}, 250, 0,0#"))
    port.write(str.encode("show5#"))
    time.sleep(.4)
    for i in range(7):
        port.write(str.encode(f"5, {i+106}, 100, 100,100#"))
    port.write(str.encode("show5#"))
