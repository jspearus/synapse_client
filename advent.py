...
def advent():
    ...
    for i in range(50):
        port.write(str.encode(f"5,{i},0,200,0#"))
...
def morningAdvent():
    ...
    for i in range(50):
        ...
        time.sleep(.02)
    for i in range(100, -1, -1):
        port.write(str.encode(f"0,{i},0,50,0#"))
        port.write(str.encode("show#"))
        time.sleep(.07)
    day = int(day.strftime("%d")) * 2
    for i in range(0, (day*2), 2):
        ...
        port.write(str.encode("show1#"))
        time.sleep(.1)
        port.write(str.encode(f"2,{i},50,0,0#"))
        port.write(str.encode("show2#"))
        time.sleep(.1)
        port.write(str.encode(f"3,{i},50,0,0#"))
        port.write(str.encode("show3#"))
        time.sleep(.1)
        port.write(str.encode(f"4,{i},50,0,0#"))
        port.write(str.encode("show4#"))
        time.sleep(.1)
